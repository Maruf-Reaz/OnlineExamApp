...
namespace ExamApp.Migrations
{
    ...
    [Migration("20210226083015_SeriesChanged")]
    partial class SeriesChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamApp.Models.Exam", b =>
                {
                    ...
                    b.Property<double?>("EachQuestionMark");

                    b.Property<int>("ExamTypeId");

                    b.Property<TimeSpan>("From");

                    b.Property<bool>("HasSets");

                    b.Property<bool>("IsNotCountable");
            ...
            modelBuilder.Entity("ExamApp.Models.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("FromMark");

                    b.Property<double>("Gpa");

                    b.Property<double>("ToMark");
            ...
            modelBuilder.Entity("ExamApp.Models.SeriesExam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("SelectedExamId");

                    b.ToTable("SeriesExams");
                });

            modelBuilder.Entity("ExamApp.Models.SeriesExamItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("SeriesExamId");

                    b.HasKey("Id");

                    b.HasIndex("ExamId");

                    b.HasIndex("SeriesExamId");

                    b.ToTable("SeriesExamItems");
                });
            ...
            modelBuilder.Entity("ExamApp.Models.StudentAnswer", b =>
                {
                    ...
                    b.Property<double>("ActualObtailedMark");
            ...
            modelBuilder.Entity("ExamApp.Models.StudentQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExamApp.Models.Exam", b =>
                {
                    ...
                    b.HasOne("ExamApp.Models.ExamType", "ExamType")
                        .WithMany()
            ...
            modelBuilder.Entity("ExamApp.Models.SeriesExam", b =>
                {
                    ...
                    b.HasOne("ExamApp.Models.Exam", "SelectedExam")
                        .WithMany()
                        .HasForeignKey("SelectedExamId");
                });
            ...
            modelBuilder.Entity("ExamApp.Models.SeriesExamItem", b =>
                {
                    ...
                    b.HasOne("ExamApp.Models.SeriesExam", "SeriesExam")
                        .WithMany("SeriesExamItems")
                        .HasForeignKey("SeriesExamId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
